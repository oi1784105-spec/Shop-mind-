...
async def async_chat(dialog, messages, stream=True, **kwargs):
    ...
    async def decorate_answer(answer):
        ...
        # Structured references are useful even when inline citation generation
        # is disabled. Product clients such as ShopMind render these chunks in a
        # separate "answer evidence" panel and deliberately avoid the much
        # longer citation prompt required for marker insertion.
        if knowledges:
