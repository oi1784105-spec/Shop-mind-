...
Esempio: un messaggio di 1 KB con embedding a 1024 dimensioni usa ~9 KB. Il limite predefinito di 5 MB contiene ~500 messaggi di questo tipo.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Esegui un test di recupero per verificare se ShopMind riesce a recuperare il contenuto previsto per il LLM.',
      Parse: 'Analizza',
      dataset: 'Dataset',
      ...
      rerankTip: `Opzionale. Se lasciato vuoto, ShopMind userà una combinazione di similarità delle parole chiave ponderata e similarità coseno vettoriale ponderata; se viene selezionato un modello rerank, un punteggio di reranking ponderato sostituirà la similarità coseno vettoriale ponderata. Tieni presente che l'uso di un modello rerank aumenterà significativamente il tempo di risposta del sistema. Se desideri usare un modello rerank, assicurati di usare un reranker SaaS; se preferisci un modello rerank distribuito localmente, assicurati di avviare ShopMind con docker-compose-gpu.yml.`,
      topK: 'Top-K',
...
`,
    ...
    knowledgeConfiguration: {
      ...
      tableColumnModeAutoDescription:
        'Tutte le colonne sono incluse nel testo del chunk e memorizzate come metadati (predefinito ShopMind).',
...
**Regole essenziali:**
  ...
  - **Considera sempre** l'intera cronologia della conversazione.`,
      ...
      **Regole essenziali:**
      ...
      betaError:
        'Per favore acquisisci prima una chiave API ShopMind dalla pagina Impostazioni di sistema.',
