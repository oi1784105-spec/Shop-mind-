...
/**
 * The RAGFlow operations UI is published by the local Compose deployment on
 * port 8081 (HTTPS deployments may use 8443). Keep this client-side switch
 * limited to the operations host; the ShopMind product UI on port 8080 keeps
 * its normal account/password login flow.
 */
export const isAdminOpsHost = () =>
  typeof window !== 'undefined' &&
  (window.location.port === '8081' || window.location.port === '8443');
